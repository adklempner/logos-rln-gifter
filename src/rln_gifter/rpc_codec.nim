# Protobuf encode/decode for the RLN membership allocation messages
# FEATURE: RLN membership gifter wire codec (byte-identical to nwaku port)

{.push raises: [].}

import std/options
import ./protobuf_shims, ./rpc
